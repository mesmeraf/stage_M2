...
\caption{\textbf{Différence d'énergie minimale par rapport à l'état ancêtre pour les BIME du jeux de données GSE61327\_ALE retrouvé par les 3 méthodes en fonction de la classification des BIME.}}
\end{figure}
