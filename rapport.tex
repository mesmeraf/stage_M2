...
\begin{tabular}{|l|c|c|c|}
  \hline
  \multirow{2}{*}{Wilcoxon test p-valeurs} & \multicolumn{3}{|c|}{Élément transcriptionnel} \\
  \cline{2-4}
 ...
 \hline
\end{tabular}}
\caption{\textbf{P-valeurs des tests de Wilcoxon des $I_{expr}$ de la présence des éléments transcriptionnels comparée à leur absence.} Les p-valeurs sont présentées en présence et en absence de BIME et renvoient aux cas de la \autoref{fig:expression_operon_reg}.
