...
\begin{SCfigure}[][h!]
\fbox{\includegraphics[scale=0.5]{figures/genesOperonReg_histoDens_GSE61327_ALE.png}
...
\begin{tabular}{|c|c|c|c|c|}
 ...
 \multirow{3}{*}{Présence de BIME}& GSE61327\_ALE & $0.259$ & $0.444$ & $0.441$ \\ 
  ...
  \hline
\end{tabular}}
\caption{\textbf{P-valeurs des tests de rang de Wilcoxon des $I_{expr}$ en présence/absence de BIME dans les cas de RIG ans ET par rapport aux différents éléments transcriptionnels présents dans les RIG sur les 3 jeux de données.}
