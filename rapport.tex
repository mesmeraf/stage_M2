...
Le fichier \gls{gff} d'annotation du génome d'\textit{E. coli K12} a été généré par un script Perl à partir du fichier \href{http://www.ncbi.nlm.nih.gov/nuccore/NC_000913.2}{GenBank}. Les fichiers répertoriant les opérons et les promoteurs proviennent de \href{http://regulondb.ccg.unam.mx/}{RegulonDB}. \textcolor{red}{\textbf{Pour les opérons, les preuves de leur existences}}


 les terminateurs de transcription (source \href{http://csbl.bmb.uga.edu/DOOR/}{Door\up{2}DB}) ainsi que les REP et BIME (source laboratoire)
...
\section*{Préparation des fichiers de référence pour l'analyse statistique}
 ont été transformés au format \gls{bed} grâce à des scripts Python.
