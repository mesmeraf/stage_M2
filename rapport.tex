...
\begin{SCfigure}[][t]
\fbox{\includegraphics[scale=0.4]{figures/igr_distance.png}
\caption{\textbf{Distances inter-géniques dans les opérons avec et sans BIME.} En bleu absence de BIME dans la région inter-génique, en rouge présence de BIME. Nous observons une croissance de 2 à 3 fois de la taille de cette région lors de la présence de BIME.}
...
\begin{SCfigure}[][t]
\fbox{\includegraphics[scale=0.4]{figures/profil_plot.png}
