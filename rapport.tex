...
Pour le génome d'\textit{E. coli K-12}, 93 REP ont été répertoriées comme étant solitaires sur les 605 annotées par l'équipe. Les REP sont organisées en 287 BIME pouvant composées d'une ou plusieurs d'entre elles. 

\subsection*{Visualisation des données d'expression sur le génome}
